        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="inline-flex items-center gap-3 mb-8">
              <span className="h-px w-8 bg-[#F4B123]"></span>
              <span className="text-sm font-semibold tracking-widest text-[#F4B123] uppercase">
            ...
            <div className="flex flex-col sm:flex-row items-start gap-6">
              ...
              <a
                href="#about"
                className="px-10 py-4 rounded-none font-medium text-lg tracking-wide text-slate-900 border-b border-slate-900 hover:text-[#F4B123] hover:border-[#F4B123] transition-colors flex items-center gap-2"
              >
                Conocer metodología
            ...
            <div className="relative aspect-[4/5] w-full max-w-md mx-auto">
              ...
              <div className="absolute bottom-1/4 -right-8 bg-slate-900 p-6 shadow-2xl max-w-xs text-white animate-float" style={{ animationDelay: "2s" }}>
                <div className="flex items-center gap-4 mb-2">
                  <div className="w-10 h-10 bg-white/10 flex items-center justify-center text-[#F4B123]">
