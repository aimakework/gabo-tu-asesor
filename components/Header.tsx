  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-[1000] bg-white/90 backdrop-blur-md border-b border-slate-100 transition-all duration-300">
      <div className="flex justify-between items-center px-6 py-5 max-w-7xl mx-auto">
        ...
        <nav className="hidden md:flex items-center gap-8 text-sm font-medium text-slate-500 tracking-wide uppercase">
          ...
          <div className="flex items-center gap-2">
            {socialLinks.map((item) => (
              <a
                ...
                className="w-9 h-9 rounded-lg flex items-center justify-center text-slate-500 hover:text-[#F4B123] hover:bg-slate-100 transition-colors"
