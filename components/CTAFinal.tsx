      ...
      <div className="max-w-4xl mx-auto px-6 relative z-10">
        <div className="mb-12">
          ...
          <h2 className="font-[family-name:var(--font-heading)] text-4xl md:text-5xl font-bold text-white mb-6 leading-tight">
            ¿Listo para tener <span className="text-[#F4B123]">claridad financiera</span>?
          </h2>
        ...
        <button
          onClick={openModal}
          className="btn-primary px-12 py-5 rounded-xl font-bold text-xl tracking-wide shadow-2xl shadow-[#F4B123]/20 hover:shadow-[#F4B123]/40 transition-all duration-300 transform hover:-translate-y-1"
        >
