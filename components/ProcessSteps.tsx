    ...
    <section className="py-24 bg-white">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {steps.map((step, i) => (
            <div key={i} className="relative pt-8 border-t border-slate-200 group hover:border-amber-500 transition-colors duration-500">
              <span className="text-4xl font-serif text-slate-200 group-hover:text-amber-500 transition-colors duration-500 block mb-6">
                {step.num}
              </span>
